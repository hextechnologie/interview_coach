  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <label className="cursor-pointer">
        <div className="photo-upload-btn flex items-center gap-2 px-4 py-2 rounded-lg bg-purple-600 hover:bg-purple-700 transition-colors text-white text-sm font-medium shadow-lg shadow-purple-500/50">
          {uploading ? (
            <>
